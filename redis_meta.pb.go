...
func init() {
	proto.RegisterType((*IPAddr)(nil), "redis.IPAddr")
	proto.RegisterType((*Slave)(nil), "redis.Slave")
	proto.RegisterType((*Instance)(nil), "redis.Instance")
	proto.RegisterType((*RawInstance)(nil), "redis.RawInstance")
	proto.RegisterEnum("redis.RedisRole", RedisRole_name, RedisRole_value)
}
